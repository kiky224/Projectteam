...
import urllib.request
URL = 'http://192.168.10.4/uploads/pic_img.jpg'
...
print(nowdate)
db = pymysql.connect(host='192.168.10.4', port=3306, user='test', passwd='1234', db='carnum', charset='utf8')
curs = db.cursor()
sqls = "SELECT carId FROM cartable WHERE carId = %s"
val3 = chars
curs.execute(sqls,(val3))

result = curs.fetchone()
if result is None:
    sql = "insert into cartable (carId,intime) values(%s,%s)"
    val1 = chars
    val2 = nowdate
